<script lang="ts">
  ...
  let themePref = $state(
    (typeof localStorage !== "undefined" && localStorage.getItem("ls-theme")) || "system",
  );
  ...
  function cycleTheme() {
    ...
    localStorage.setItem("ls-theme", themePref);
    applyTheme();
  }
  ...
  let themeIcon = $derived(
    themePref === "system"
      ? '<circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/><path d="M12 12a4 4 0 0 0 8 0 5 5 0 0 0-8 0Z"/>'
      : themePref === "light"
...
<header class="hdr">
  ...
  <div class="hdr-r">
    ...
    <button class="iconbtn" onclick={cycleTheme} title="Theme: {themePref}">
    ...
    <a class="iconbtn" href="https://github.com/mmacpherson/python-lucide" target="_blank" title="View source">
      <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="var(--tx2)" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>
    </a>
  </div>
</header>
